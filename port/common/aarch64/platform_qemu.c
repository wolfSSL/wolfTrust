...
/* The suite's trusted watchdog (its PLATFORM_TWDOG_INTID): any test partition
 * may be the one to claim it, and none may claim another interrupt. */
#define WT_ACS_TWDOG_INTID  56u
#define WT_ACS_INTIDS       { WT_ACS_TWDOG_INTID }, 1u
